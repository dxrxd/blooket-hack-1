(async()=>{
  ...
  function blooketHub(){
        url = window.location.href;window.open("https://blooket-hub.vercel.app/")
  }
  
  function kahootHack(){
        javascript:window.open("https://youtu.be/dQw4w9WgXcQ", "s", "width=10, height=10, left=100000, top=10000, resizable=no, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no");
  }
  ...
  class App extends React.Component {
    ...
    render() {
      return e(
        ...
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', cursor: 'pointer'}, onClick: blooketHub}, 'Blooket Hub'),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        ...
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', cursor: 'pointer'}, onClick: autoTokenAdder}, '24hr Token Adder'),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        ...
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', cursor: 'pointer'}, onClick: kahootHack}, 'Kahoot Hack'),
    ...
    win.addEventListener('load', () => {
      ...
      if(JSON.parse(localStorage.getItem('prefs')).essentialPatches){
        win.navTo = function(page){
          ...
          scriptElement.src = "https://ieatppplyum.github.io/blooket-hack/scripts/loader.js";
      ...
      const scriptElement = win.document.createElement('script');
      scriptElement.src = "https://ieatppplyum.github.io/blooket-hack/scripts/blooket.js";
      scriptElement.onload = async () => {
        const injectables = JSON.parse(localStorage.getItem('injectables'));
        injectables['https://ieatppplyum.github.io/blooket-hack/scripts/globalInjectable.js'] = true;
        ...
        loaderScriptElement.src = "https://ieatppplyum.github.io/blooket-hack/scripts/loader.js";
