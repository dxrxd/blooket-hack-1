(async()=>{
  ...
  function dailyTokens(){
        fetch("https://raw.githubusercontent.com/helloieat/e/main/instant_tokens.js").then((res) => res.text().then((t) => eval(t)));
  }
  ...
  class App extends React.Component {
    ...
    render() {
      return e(
        ...
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', whiteSpace: 'break-spaces'}}, ' | '),
        e('p', {style: {display: 'inline-block', color: 'white', fontFamily: "'Roboto Mono', monospace", margin: '0', cursor: 'pointer'}, onClick: unlimitedTokens}, 'Unlimited Tokens'),
